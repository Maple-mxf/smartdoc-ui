import EditableTabSwitchComponent from "../common/EditableTabSwitchComponent";
import {EditableCodeTextComponent} from "../common/common";
...
export default function RequestBodyEditableViewComponent(props) {
    const {doc} = props;
    return (
        <div>
